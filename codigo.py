...
def distributions(tipo):
	return {
		...
		'server': random.expovariate(1.0/1), 
	}.get(tipo, 0.0)
...
print('Throughput = ', contaTerminos/1)

print('Tempo de Serviço server = ', tempoServico[0])
print('Tempo Médio de Serviço server = ', tempoServico[0]/1)
print('Utilização server = ', tempoServico[0]/1)
print('Tempo de resposta server = ', tempoResposta[0])
print('Tempo Médio de resposta server = ', tempoResposta[0]/1)
print('Tempo Médio em Fila server = ',(tempoResposta[0]/1)-(tempoServico[0]/1))
print('----------------------------------------------------')
